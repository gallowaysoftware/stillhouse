...
UPDATE materials SET archived = TRUE WHERE id = $1 RETURNING id, tenant_id, name, kind, uom, supplier, notes, extract_pct, moisture_pct, archived, created_at, updated_at
`
...
INSERT INTO materials (
    ...
    $1, $2, $3, $4, $5, $6, $7, $8
) RETURNING id, tenant_id, name, kind, uom, supplier, notes, extract_pct, moisture_pct, archived, created_at, updated_at
`
...
SELECT id, tenant_id, name, kind, uom, supplier, notes, extract_pct, moisture_pct, archived, created_at, updated_at FROM materials WHERE id = $1
`
...
SELECT id, tenant_id, material_id, supplier_lot, quantity_received, quantity_on_hand, received_at, notes, created_at, updated_at FROM material_lots WHERE id = $1
`
...
SELECT id, tenant_id, material_id, supplier_lot, quantity_received, quantity_on_hand, received_at, notes, created_at, updated_at FROM material_lots
...
SELECT id, tenant_id, name, kind, uom, supplier, notes, extract_pct, moisture_pct, archived, created_at, updated_at FROM materials
...
UPDATE materials SET archived = FALSE WHERE id = $1 RETURNING id, tenant_id, name, kind, uom, supplier, notes, extract_pct, moisture_pct, archived, created_at, updated_at
`
