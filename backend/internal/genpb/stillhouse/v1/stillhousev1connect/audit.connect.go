...
const (
	...
	AuditServiceName = "stillhouse.v1.AuditService"
)
...
const (
	...
	// ListAuditEvents RPC.
	AuditServiceListAuditEventsProcedure = "/stillhouse.v1.AuditService/ListAuditEvents"
)

// AuditServiceClient is a client for the stillhouse.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the stillhouse.v1.AuditService service. By default,
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_stillhouse_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAuditEvents calls stillhouse.v1.AuditService.ListAuditEvents.
...
// AuditServiceHandler is an implementation of the stillhouse.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/stillhouse.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditEvents(context.Context, *connect.Request[v1.ListAuditEventsRequest]) (*connect.Response[v1.ListAuditEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("stillhouse.v1.AuditService.ListAuditEvents is not implemented"))
}
