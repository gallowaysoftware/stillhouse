...
const file_stillhouse_v1_user_proto_rawDesc = "" +
	...
	"\x06tenant\x18\x02 \x01(\v2\x15.stillhouse.v1.TenantR\x06tenant*h\n" +
	"\bUserRole\x12\x19\n" +
	"\x15USER_ROLE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fUSER_ROLE_OWNER\x10\x01\x12\x16\n" +
	"\x12USER_ROLE_OPERATOR\x10\x02\x12\x14\n" +
	"\x10USER_ROLE_VIEWER\x10\x032Q\n" +
	"\vUserService\x12B\n" +
	"\x05GetMe\x12\x1b.stillhouse.v1.GetMeRequest\x1a\x1c.stillhouse.v1.GetMeResponseB\xcd\x01\n" +
...
var file_stillhouse_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_stillhouse_v1_user_proto_depIdxs = []int32{
	...
	4, // 1: stillhouse.v1.User.created_at:type_name -> google.protobuf.Timestamp
	4, // 2: stillhouse.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	1, // 3: stillhouse.v1.GetMeResponse.user:type_name -> stillhouse.v1.User
	5, // 4: stillhouse.v1.GetMeResponse.tenant:type_name -> stillhouse.v1.Tenant
	2, // 5: stillhouse.v1.UserService.GetMe:input_type -> stillhouse.v1.GetMeRequest
	3, // 6: stillhouse.v1.UserService.GetMe:output_type -> stillhouse.v1.GetMeResponse
