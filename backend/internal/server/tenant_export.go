...
var exportTables = []string{
	...
	"price_lists",
	"price_list_entries",
	// Hand-entered demand forecasts, with the reason each was entered.
	// A production decision made on one is only defensible if the number
	// and its reason are both still there.
	"demand_forecasts",
