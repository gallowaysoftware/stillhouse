...
export type B266Report = Message<"stillhouse.v1.B266Report"> & {
   ...
   *
   * @generated from field: double packaged_adjustments_net_laa = 85;
   */
  packagedAdjustmentsNetLaa: number;

  /**
   * @generated from field: double packaged_adjustments_increase_laa = 86;
   */
  packagedAdjustmentsIncreaseLaa: number;

  /**
   * @generated from field: double packaged_adjustments_decrease_laa = 87;
   */
  packagedAdjustmentsDecreaseLaa: number;

  /**
   * @generated from field: int32 packaged_adjustments_count = 88;
   */
  packagedAdjustmentsCount: number;
