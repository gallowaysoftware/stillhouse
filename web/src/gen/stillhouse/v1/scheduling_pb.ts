...
export const file_stillhouse_v1_scheduling: GenFile = /*@__PURE__*/
  fileDesc("", [file_stillhouse_v1_equipment]);
...
export type ForecastLine = Message<"stillhouse.v1.ForecastLine"> & {
   ...
   *
   * @generated from field: int32 mashes = 19;
   */
  mashes: number;

  /**
   * @generated from field: bool mashes_available = 20;
   */
  mashesAvailable: boolean;

  /**
   * @generated from field: string mashes_missing = 21;
   */
  mashesMissing: string;

  /**
   * @generated from field: string mash_vessel = 22;
   */
  mashVessel: string;
  ...
  /**
   * @generated from field: bool order_by_available = 24;
   */
  orderByAvailable: boolean;

  /**
   * @generated from field: string order_by_missing = 25;
   */
...
/**
 * @generated from message stillhouse.v1.SetRecipeMashEquipmentRequest
 */
export type SetRecipeMashEquipmentRequest = Message<"stillhouse.v1.SetRecipeMashEquipmentRequest"> & {
  /**
...
/**
 * Describes the message stillhouse.v1.SetRecipeMashEquipmentRequest.
 * Use `create(SetRecipeMashEquipmentRequestSchema)` to create a new message.
 */
export const SetRecipeMashEquipmentRequestSchema: GenMessage<SetRecipeMashEquipmentRequest> = /*@__PURE__*/
  messageDesc(file_stillhouse_v1_scheduling, 15);

/**
 * @generated from message stillhouse.v1.SetRecipeMashEquipmentResponse
 */
export type SetRecipeMashEquipmentResponse = Message<"stillhouse.v1.SetRecipeMashEquipmentResponse"> & {
};

/**
 * Describes the message stillhouse.v1.SetRecipeMashEquipmentResponse.
 * Use `create(SetRecipeMashEquipmentResponseSchema)` to create a new message.
 */
export const SetRecipeMashEquipmentResponseSchema: GenMessage<SetRecipeMashEquipmentResponse> = /*@__PURE__*/
  messageDesc(file_stillhouse_v1_scheduling, 16);
...
export const SchedulingService: GenService<{
  ...
  /**
   * @generated from rpc stillhouse.v1.SchedulingService.SetRecipeMashEquipment
   */
  setRecipeMashEquipment: {
    methodKind: "unary";
    input: typeof SetRecipeMashEquipmentRequestSchema;
    output: typeof SetRecipeMashEquipmentResponseSchema;
  },
}> = /*@__PURE__*/
