...
import { ImportService } from "@/gen/stillhouse/v1/importer_pb";
import { LabService } from "@/gen/stillhouse/v1/lab_pb";
import { PurchasingService } from "@/gen/stillhouse/v1/purchasing_pb";
import { SalesService } from "@/gen/stillhouse/v1/sales_pb";
import { LabelService } from "@/gen/stillhouse/v1/label_pb";
import { CostingService } from "@/gen/stillhouse/v1/costing_pb";
import { ProvincialService } from "@/gen/stillhouse/v1/provincial_pb";
import { InvoicingService } from "@/gen/stillhouse/v1/invoicing_pb";
import { MarkedContainerService } from "@/gen/stillhouse/v1/marked_pb";
import { EquipmentService } from "@/gen/stillhouse/v1/equipment_pb";
import { SchedulingService } from "@/gen/stillhouse/v1/scheduling_pb";
import { StockCountService } from "@/gen/stillhouse/v1/stockcount_pb";
import { CertificateService } from "@/gen/stillhouse/v1/certificate_pb";
import { RetentionService } from "@/gen/stillhouse/v1/retention_pb";
import { LocationService } from "@/gen/stillhouse/v1/location_pb";
import { WorkOrderService } from "@/gen/stillhouse/v1/work_order_pb";
import { RedistillationService } from "@/gen/stillhouse/v1/redistillation_pb";
...
export const labClient = createClient(LabService, transport);
export const purchasingClient = createClient(PurchasingService, transport);
export const salesClient = createClient(SalesService, transport);
export const labelClient = createClient(LabelService, transport);
export const costingClient = createClient(CostingService, transport);
export const provincialClient = createClient(ProvincialService, transport);
export const invoicingClient = createClient(InvoicingService, transport);
export const markedClient = createClient(MarkedContainerService, transport);
export const equipmentClient = createClient(EquipmentService, transport);
export const schedulingClient = createClient(SchedulingService, transport);
export const stockCountClient = createClient(StockCountService, transport);
export const certificateClient = createClient(CertificateService, transport);
export const retentionClient = createClient(RetentionService, transport);
export const locationClient = createClient(LocationService, transport);
export const workOrderClient = createClient(WorkOrderService, transport);
export const redistillationClient = createClient(RedistillationService, transport);
